...
<div class="py-1 overflow-hidden d-flex justify-content-between border-bottom nav-create">
    <div class="mb-5 d-md-flex d-none align-self-center create ms-2 position-absolute">
        <a href="{{ route('dashboard.index') }}" class="d-flex">
            <img src="{{ asset('assets/admin/images/group1000007853.png') }}" class="ms-md-3 mb-md-1" alt="logo" />
    ...
    <div class="btn_nav d-flex justify-content-between">
        {{-- <form action="{{ route('dashboard.book.index') }}" id="main-search-form"
            ...
            <div class="ms-4 d-flex me-3">
                ...
                {{-- <a href="{{ route('dashboard.user.help') }}" class="align-self-center"> --}}
                        ...
                        <div class="d-none" id="notific">
                            ...
                            <div class="personal-notification d-flex ">
                                ...
                                <h5>New features coming! Scheduled downtime on 28 December. Save your
                                    work.</h5>
                                <i class="mt-1 fa-regular fa-circle fa-xs ms-2"></i>
                            </div>
                            <div class="d-flex ms-5 ps-3 icon">
                                <i class="mt-2 fa-solid fa-calendar-week fa-lg me-1 "></i>
                    ...
                    <div id="person-icon" class="align-self-center d-flex">
                        <img src="{{ asset('assets/admin/images/image10.png') }}" class="align-self-center ms-md-2"
                            alt="user" />
                            ...
                            <div class="shadow notification sign rounded-4 position-absolute">
                                <div class="text-center d-flex justify-content-center border-bottom">
                                    <div class="p-4 pb-1 personal ">
                                        <img src="{{ asset('assets/admin/images/image16.png') }}" alt="">
                                        <h3>{{ auth()->user()->fname . ' ' . auth()->user()->lname }}</h3>

                                        <p>{{ auth()->user()->email }}</p>


                                        {{-- <a href="{{ route('dashboard.plans.index') }}" --}} <a href="#"
                                ...
                                <div class="p-4 info-personl border-bottom">
                                    {{-- <a href="{{ route('dashboard.profile') }}" --}} <a href="#"
                                        class="{{ request()->is('profile') ? 'active' : '' }}">
                                        <h4>My Profile</h4>
                                    </a>

                                    {{-- <a href="{{ route('dashboard.book.index') }}" class="mb-3 d-block h4"> --}}
                                        ...
                                        {{-- <a href="{{ route('dashboard.plans.index') }}" class="mb-3 d-block h4">
                                            ...
                                            {{-- <a href="{{ route('dashboard.user.help') }}" class="mb-3 d-block h4">
                                                --}}
                                                <a href="#" class="mb-3 d-block h4">
                                                    <h4>Help</h4>
                                                </a>
